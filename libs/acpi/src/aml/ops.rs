// use super::{item, ParseResult};
// use core::alloc::Allocator;

// macro_rules! op_parser {
//     ($input:ident, $opcode:literal) => {
//         item($input, $opcode)
//     };
//     ($input:ident, ($opcode1:literal, $opcode2:literal)) => {{
//         let (input, _) = item($input, $opcode1)?;
//         item(input, $opcode2)
//     }};
// }
...
//             impl $name {
//                 pub fn p<A: Allocator + Clone>(
//                   input: &[u8],
//                   _alloc: A,
//                 ) -> ParseResult<&[u8], Self> {
//                     let (input, _) = op_parser!(input, $parser)?;
//                     Ok((input, Self))
//                 }
//             }
//         )+
